...
def import_mal_username_background(user_id, mal_username):
    """
    Background worker to import MAL user list via Jikan API.
    Handles pagination without blocking the HTTP request.
    """
